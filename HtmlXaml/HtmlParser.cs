...
namespace HTMLXaml
{
    ...
    class HtmlParser
    {
        ...
        {
            int startHtmlIndex = htmlDataString.IndexOf("StartHTML:", StringComparison.CurrentCulture);
            if (startHtmlIndex < 0)
            {
            ...
            int endHtmlIndex = htmlDataString.IndexOf("EndHTML:", StringComparison.CurrentCulture);
            if (endHtmlIndex < 0)
            {
                return "ERROR: Urecognized html header";
            }
        ...
        internal static string AddHtmlClipboardHeader(string htmlString)
        {
            ...
            int startFragment = htmlString.IndexOf(HtmlStartFragmentComment, 0, StringComparison.CurrentCulture);
            if (startFragment >= 0)
            {
            ...
            int endFragment = htmlString.IndexOf(HtmlEndFragmentComment, 0, StringComparison.CurrentCulture);
            if (endFragment >= 0)
            {
